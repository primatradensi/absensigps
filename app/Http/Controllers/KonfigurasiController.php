...
class KonfigurasiController extends Controller
{
    ...
    public function storesetjamkerja(Request $request) 
    {
        ...
        try {
            ...
            return redirect('/karyawan')->with(['success' => 'Data Jam Kerja Berhasil Di Setting']);
        } catch (\Exception $e) {
            return redirect('/karyawan')->with(['warning' => 'Data Jam Kerja Gagal Di Setting']);
        }
    }
    ...
    public function updatesetjamkerja(Request $request) 
    {
        ...
        try {
            ...
            DB::roolBack();
            return redirect('/karyawan')->with(['warning' => 'Data Jam Kerja Gagal Di Update']);
        }
    }
    ...
    public function createjamkerjadept()
    {
        ...
        return view ('konfigurasi.createjamkerjadept', compact('jamkerja', 'departemen'));
    }
    ...
    public function editjamkerjadept($kode_jk_dept)
    {
        ...
        return view('konfigurasi.editjamkerjadept', compact('jamkerja', 'departemen', 'jamkerjadept', 'jamkerjadept_detail'));
    }
    ...
    public function showjamkerjadept($kode_jk_dept)
    {
        ...
        return view('konfigurasi.showjamkerjadept', compact('jamkerja', 'departemen', 'jamkerjadept', 'jamkerjadept_detail'));
    }
