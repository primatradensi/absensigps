        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <a href="#" class="btn btn-success" id="btnTambahCuti"> 
    ...
    $(function() {
        ...
        $("#frmCuti").submit(function() {
            ...
            if(kode_cuti == "") {  
                Swal.fire({
                title: 'Ooops!'
                , text: 'Kode Cuti Masih Kosong, Harus Diisi'
                , icon: 'error'
                ...
                Swal.fire({
                title: 'Ooops!'
                , text: 'Nama Cuti Masih Kosong, Harus Diisi'
                , icon: 'error'
                , confirmButtonText: 'OK'
                }).then((result) => {
                    $("#nama_dept").focus();
