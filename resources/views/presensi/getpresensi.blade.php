...
<tr>
    ...
    <td>{!! $d->jam_out != null ? $d->jam_out : '<span style="color:white;" class="badge bg-warning">Belum Absen</span>' !!}</td>
    <td>
        @if ($d->jam_out != null)
    ...
    <td>
        ...
        @endphp
            <span style="color:white;" class="badge bg-danger">Terlambat {{ $jamterlambat }}</span>
        @else
            <span style="color:white;" class="badge bg-success">Tepat Waktu</span>
        @endif
    </td>
    <td>
        ...
        {{-- <a href="#" class="btn btn-success btn-sm koreksiabsensi">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-edit-circle" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 15l8.385 -8.415a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3z" /><path d="M16 5l3 3" /><path d="M9 7.07a7 7 0 0 0 1 13.93a7 7 0 0 0 6.929 -6" />
            </svg>
        </a> --}}
    </td>
</tr> 
...
<tr>
    ...
    <td>{{ $d->kode_dept }}</td>
    <td> 
        <span style="color:white;" class="badge bg-danger">Belum Absen</span>
    </td>
    <td> 
        <span style="color:white;" class="badge bg-danger">Belum Absen</span>
    </td>
    ...
    <td>
        @if ($d->status == "i")
            <span class="badge bg-warning" style="color: white">I</span>     
        @elseif ($d->status == "s")
            <span class="badge bg-info" style="color: white">S</span>      
        @endif
    </td>
    <td>{{ $d->keterangan }}</td> 
    {{-- <td>
...
<script>
    ...
    //             }
    //         });
    //         $("#modal-koreksiabsensi").modal("show");
    //     });
    });
