                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($d->status_approved==1)
                                        <span style="color: white;" class="btn btn-success">Disetujui</span>
                                    @elseif ($d->status_approved==2)
                                        <span style="color: white;" class="btn btn-danger">Ditolak</span>
                                    @else
                                    <span style="color: white;" class="btn btn-warning">Menunggu Persetujuan</span>
                                    @endif
                                </td>
                                <td>
                                    @if ($d->status_approved==0)
                                    <a href="#" style="color: white;" class="btn btn-primary approve" kode_izin="{{ $d->kode_izin }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-loader" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 6l0 -3" /><path d="M16.25 7.75l2.15 -2.15" /><path d="M18 12l3 0" /><path d="M16.25 16.25l2.15 2.15" /><path d="M12 18l0 3" /><path d="M7.75 16.25l-2.15 2.15" /><path d="M6 12l-3 0" /><path d="M7.75 7.75l-2.15 -2.15" />
                                    </svg>
                                    Waiting
                                    </a>
                                    @else
                                    <a href="/presensi/{{ $d->kode_izin }}/batalkanizinsakit" style="color: white;" class="btn btn-danger">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-x" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 5a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-14z" /><path d="M9 9l6 6m0 -6l-6 6" />
                                    </svg>
                                    Cancel
                                    </a>
                                    @endif
