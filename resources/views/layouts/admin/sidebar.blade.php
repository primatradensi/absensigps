<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
        <div class="container-fluid">
          ...
          <h1 class="navbar-brand navbar-brand-autodark">
            <a href=".">
              <img src="{{ asset('assets/img/logoabsensi.png') }}" width="160" height="110" alt="logo Absens KPT" >
            </a>
          </h1>
          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is(['presensi/izinsakit']) ? 'active' : '' }}" href="/presensi/izinsakit" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-list-details" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M13 5h8" /><path d="M13 9h5" /><path d="M13 15h8" /><path d="M13 19h5" /><path d="M3 4m0 1a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v4a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1z" /><path d="M3 14m0 1a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v4a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1z" />
                  </svg>
                  </span>
                  <span class="nav-link-title">
                    Data Izin / Sakit  
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle {{ request()->is(['presensi','presensi/*']) ? 'show' : '' }}" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                ...
                <div class="dropdown-menu {{ request()->is(['presensi','presensi/*']) ? 'show' : '' }}">
                    <div class="dropdown-menu-columns">
                        <div class="dropdown-menu-column">
                            ...
                            <a class="dropdown-item {{ request()->is(['presensi','presensi/uploadlaporan']) ? 'active' : '' }}" href="/presensi/uploadlaporan">
                                Upload
                            </a>
                        </div>
                    </div>
                ...
                <div class="dropdown-menu {{ request()->is(['konfigurasi','konfigurasi/*']) ? 'show' : '' }}">
                    <div class="dropdown-menu-columns">
                        <div class="dropdown-menu-column">
                            ...
                            <a class="dropdown-item  {{ request()->is(['konfigurasi','konfigurasi/jamkerjadept']) ? 'active' : '' }}" href="/konfigurasi/jamkerjadept">
